...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<c:url value="/resources/img/leafIcon.jpg" />">

    <title>Green Leaves Bank</title>
  ...
  <body>
	    ...
	    <nav class="navbar navbar-inverse navbar-fixed-top">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="welcome"><img alt="greenleavesbank Logo" src="<c:url value="/resources/img/leafIcon.jpg" />"></a>
	        </div>
	      </div>
	    </nav>
	</header>
	...
	<!-- Registration form -->
	<main class="mainContent bank-template" role="main">
		<div>

  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
 	<meta name="description" content="Web-based application to display results of Tzuyu Tool">
    <meta name="author" content="vineeS@greenleaves">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <link rel="icon" href="<c:url value="/resources/img/leafIcon.jpg" />"width="100" height="100">
    <title>WebAppForBank</title>
